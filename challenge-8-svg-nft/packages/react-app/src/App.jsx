...
const targetNetwork = NETWORKS; // <------- select your target frontend network (localhost, rinkeby, xdai, mainnet)
...
function App(props) {
  ...
  useEffect(() => {
    const updateYourCollectibles = async () => {
      ...
      console.log(
        "KLLJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJ",
        collectibleUpdate,
        "adasdasdasdasdasdasasd",
      );
  ...
  */
  ...
  const [ethPriceForHappyLoogie, setEthPriceForHappyLoogie] = useState(0);
              ...
              {isSigner ? (
                <>
                  <Button
                    type={"primary"}
                    onClick={() => {
                      tx(writeContracts.YourCollectible.mintItem(ethPriceForHappyLoogie));
                    }}
                  >
                    MINT
                  </Button>
                  <br />
                  <label htmlFor="ETHPrice">
                    Enter the ETH price (in $) for which you wanna see your loogie happy?
                  </label>
                  <br />
                  <input
                    id="ETHPrice"
                    style={{ color: "black" }}
                    value={ethPriceForHappyLoogie}
                    onChange={e => setEthPriceForHappyLoogie(e.target.value)}
                  />
                </>
              ) : (
